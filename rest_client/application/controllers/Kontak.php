...
Class Kontak extends CI_Controller{
    ...
    function __construct() {
        parent::__construct();
        $this->API="https://nabilfachrezi.000webhostapp.com/rest/rest_ci/index.php";
    ...
    function index(){
        $data['telepon'] = json_decode($this->curl->simple_get($this->API.'/kontak'));
    ...
    function edit(){
        if(isset($_POST['submit'])){
            ...
            $data['telepon'] = json_decode($this->curl->simple_get($this->API.'/kontak',$params));
