					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="panel">
								...
								<?php echo form_hidden('id',$telepon[0]->id);?>
								<div class="panel-heading">
									<h3 class="panel-title">Form</h3>
								</div>
								<div class="panel-body">
								<table>
								<tr><td>ID</td><td><?php echo form_input('',$telepon[0]->id,"disabled");?></td></tr>
								<tr><td>NAMA</td><td><?php echo form_input('nama',$telepon[0]->nama);?></td></tr>
								<tr><td>NOMOR</td><td><?php echo form_input('nomor',$telepon[0]->nomor);?></td></tr>
								<tr><td colspan="2">
